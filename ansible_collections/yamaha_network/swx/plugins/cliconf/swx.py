...
authors:
  - Yamaha Corporation
cliconf: swx
short_description: Use swx cliconf to run command on Yamaha SWX devices.
description:
  - This swx plugin provides low level abstraction apis for
    sending and receiving CLI commands from Yamaha SWX devices.
version_added: "2.10"
"""
